...
<div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="card-block">
                            <h2 class="card-title"><a href="">{{substr($blog -> title, 0, 40) }}</a></h2>
                            ...
                            <div class="metafooter">
								...
								<span class="post-name"><a href="author.html">{{ $blog->name }}</a></span><br/>
    ...
    <section class="recent-posts">
        ...
        <div class="card-columns listrecent">
            ...
            <div class="card">
                <a href="post.html">
                    <img class="img-fluid" src="{{asset('frontEndAsset')}}/assets/img/demopic/8.jpg" alt="">
                </a>
                <div class="card-block">
            ...
            <div class="card">
                <a href="post.html">
                    <img class="img-fluid" src="{{asset('frontEndAsset')}}/assets/img/demopic/9.jpg" alt="">
                </a>
                <div class="card-block">
            ...
            <div class="card">
                <a href="post.html">
                    <img class="img-fluid" src="{{asset('frontEndAsset')}}/assets/img/demopic/10.jpg" alt="">
                </a>
                <div class="card-block">
