...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="logo mb-5">
                <div class="flex justify-center" style="height: 100px; width: 100px; margin: auto">
            ...
            <div class="product-form col-md-12">
                <form action="{{ route('update-product') }}" method="post" enctype="multipart/form-data">
                   ...
                   <div class="mb-2 col-md-12 ">
                    ...
                    <div class="col-auto">
                        <button type="submit" class="btn btn-primary mb-3 form-control">Update Product</button>
                    </div>
                </form>
